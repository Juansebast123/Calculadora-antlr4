...
class LabeledExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LabeledExprParser#float.
    def enterFloat(self, ctx:LabeledExprParser.FloatContext):
        pass

    # Exit a parse tree produced by LabeledExprParser#float.
    def exitFloat(self, ctx:LabeledExprParser.FloatContext):
        pass
